...
Multi-agent systems are becoming increasingly pervasive in today's society in a wide variety of domains ranging from x to y. Globally, we are moving towards an age of autonomy and systems that exhibit redundancy, ... will be at the heart of research for many years to come. Search-and-rescue (SAR) is a domain that is highly suitable to autonomous systems that can be operated remotely, due to the highly dangerous and uncertain nature of disaster scenarios that require management.\par
