...
Multi-agent systems are becoming increasingly pervasive in today's society, garnering interest and research funding in a variety of domains ranging from home automation to undersea exploration. Globally, we are moving towards an age of autonomy and systems of robots that exhibit redundancy, modularity, robustness and autonomy will be at the heart of research for many years to come. \par
Autonomous systems that can be operated remotely are highly suitable to disaster scene management, due to their highly dangerous and uncertain nature. This thesis outlines the design and implementation of a multi-agent system, the goal of which is to solve a real-world problem in the domain of disaster scene management. The real-world problem scenario involves robotic aerial vehicles and robotic ground vehicles that have sensors and actuators to interact with their environment. The framework developed defining the multi-agent system is described abstractly and can be used with different physical agents, with few restrictions on the physical specification of the agents.\par
