...
\begin{enumerate}
    ...
    \item Goal-based agents: These agents are an extension to model-based reflex agents. They have some information about whether they have reached a "goal" state, which is desirable. The agent can choose actions to take based on the model. %Define what a goal state is.
