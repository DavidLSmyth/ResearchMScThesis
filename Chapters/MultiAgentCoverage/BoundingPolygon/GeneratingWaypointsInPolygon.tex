...
\begin{figure}%
    \centering
    \subfloat[Odd number of crossings]{{\includegraphics[width=7cm,height=5cm]{Chapters/MultiAgentCoverage/Figs/CrossingTestPos.PNG} }}%
    \subfloat[Even number of crossings]{{\includegraphics[width=7cm,height=5cm]{Chapters/MultiAgentCoverage/Figs/CrossingTestNeg.PNG} }}%
...
\subfloat{\includegraphics[width=70mm, height=65mm]{Chapters/MultiAgentCoverage/Figs/RegionOne.PNG}}
%\end{wrapfigure}
\hspace{0.2em}
%\subfloat[Grid points with a latitude spacing of 30m and a longitude spacing of 25m.]
\subfloat{\includegraphics[width=70mm, height=65mm]{Chapters/MultiAgentCoverage/Figs/RegionTwo.PNG}}
