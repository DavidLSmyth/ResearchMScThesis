...
\begin{itemize}
    ...
    \item There is only a single UAV operating in the region.
    \item The UAV has unlimited battery capacity.
    ...
    \item The UAV is assumed to have a GPS sensor that is accurate to beyond the sensor resolution (implying that the UAV moves to discrete grid locations without drift).
    ...
    \item There exists a path that the UAV can follow between any two given grid cells.
\end{itemize}
