...
\renewcommand{\algorithmicensure}{\textbf{Output:}}
%Input
\REQUIRE $ \newline initial\_estimated\_state = P(x_{0} | e_{0})=bel(x_{0}), \quad\text{ The initial estimated state}
...
\hfill\pagebreak
\STATE located\_sources\leftarrow empty array
\WHILE{located\_sources.length \leq K}
\STATE test
\ENDWHILE
