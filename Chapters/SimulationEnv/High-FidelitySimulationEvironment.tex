...
The following works that we published related to the development of the simulation environment are discussed in this chapter: \cite{Smyth2018AInvestigation}, \cite{Smyth2018UsingDrones}.
